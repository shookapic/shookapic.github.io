...
const fr: Content = {
  ...
  sideProjects: [
    {
      name: 'Nen',
      description: 'Un battle royale 3D open source dans le navigateur — réseau multijoueur temps réel et déplacements fluides.',
      tech: ['TypeScript', 'Three.js', 'WebSockets'],
      url: 'https://github.com/Shookapic/Nen',
    },
    {
      name: 'Flowfy',
      description: 'Une alternative à Zapier : connecter des services et automatiser les flux entre eux.',
      tech: ['Node', 'React'],
      url: 'https://github.com/Shookapic/Flowfy',
    },
    {
      name: 'GPTerminal',
      description: 'ChatGPT sans quitter le terminal.',
      tech: ['C++'],
      url: 'https://github.com/Shookapic/GPTerminal',
    },
    {
      name: 'Fractal-Lock',
      description: 'Un écran de verrouillage qui affiche des fractales pendant votre absence.',
      tech: ['Rust'],
      url: 'https://github.com/Shookapic/Fractal-Lock',
    },
    {
      name: 'Immune-Defense',
      description: 'Un tower defense où les tours sont votre système immunitaire.',
      tech: ['C#', 'Unity'],
      url: 'https://github.com/Shookapic/Immune-Defense',
    },
    {
      name: 'Arcade',
      description: 'Une borne d’arcade modulaire avec trois jeux classiques et des bibliothèques graphiques interchangeables à chaud.',
      tech: ['C++'],
